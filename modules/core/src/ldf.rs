...
use std::{str::FromStr, collections::BTreeMap, fmt::Debug};
...
mod tests {
    ...
    fn test_from_str() {
        ...
        let mut res = vec![
            ...
            ("rspPos", Value::String("0.0000\u{1f}0.0000\u{1f}0.0000".to_string())),
            ("rspRot", Value::String("1.0000 \u{1f} 0.0000 \u{1f} 0.0000 \u{1f} 0.0000".to_string())),
