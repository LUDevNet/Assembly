...
fn test_write_table_without_columns() {
    let mut out = Vec::new();
    let db = Database {
        tables: vec![Table::new(Latin1String::encode("Foobar"), 0)],
    };
    db.write(&mut out).unwrap();
    let cmp: &'static [u8] = &[
...
fn test_write_table_with_column() {
    let mut out = Vec::new();
    let mut table = Table::new(Latin1String::encode("Foobar"), 0);
...
fn test_write_table_with_columns() {
    ...
    let mut table = Table::new(Latin1String::encode("Foobar"), 0);
    table.push_column(ValueType::Integer, Latin1String::encode("foo"));
    table.push_column(ValueType::Boolean, Latin1String::encode("bar"));
    let db = Database {
        tables: vec![table],
    };
    db.write(&mut out).unwrap();
...
fn test_write_tables_with_columns() {
    ...
    // Create first table
    let mut table0 = Table::new(Latin1String::encode("Foobar"), 0);
    table0.push_column(ValueType::Integer, Latin1String::encode("foo"));
    table0.push_column(ValueType::Boolean, Latin1String::encode("bar"));

    // Create second table
    let mut table1 = Table::new(Latin1String::encode("Players"), 0);
    table1.push_column(ValueType::Integer, Latin1String::encode("ID"));
    table1.push_column(ValueType::Text, Latin1String::encode("displayName"));
...
fn test_write_table_with_data() {
    ...
    // Create first table
    let mut table0 = Table::new(Latin1String::encode("Foobar"), 2);
    table0.push_column(ValueType::Integer, Latin1String::encode("foo"));
    table0.push_column(ValueType::Boolean, Latin1String::encode("bar"));
...
fn test_write_tables_with_data() {
    ...
    let mut table1 = Table::new(Latin1String::encode("Players"), 4);
    table1.push_column(ValueType::Integer, Latin1String::encode("ID"));
    table1.push_column(ValueType::Text, Latin1String::encode("displayName"));
